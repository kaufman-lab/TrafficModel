...
traffic_nngp_a1 <- spConjNNGP(log_traffic~1,
...
saveRDS(traffic_nngp_a1,'a1_full_nocov_log.rds')
proc.time() - ptm
...
traffic_nngp_a2 <- spConjNNGP(log_traffic~1,
                              coords=c("LINE_LONGI","LINE_LATIT"),
                              data=prepare_dat,
                              cov.model="exponential", sigma.sq.IG=c(2,
                                                                     0.5*var(prepare_dat$log_traffic)),
...
saveRDS(traffic_nngp_a2,'a2_full_nocov_log.rds')
proc.time() - ptm
...
traffic_nngp_a3 <- spConjNNGP(log_traffic~1,
                              coords=c("LINE_LONGI","LINE_LATIT"),
                              data=prepare_dat,
                              cov.model="exponential", sigma.sq.IG=c(2,
                                                                     0.5*var(prepare_dat$log_traffic)),
...
saveRDS(traffic_nngp_a3,'a3_full_nocov_log.rds')
proc.time() - ptm
...
traffic_nngp_a4 <- spConjNNGP(log_traffic~1,
                              coords=c("LINE_LONGI","LINE_LATIT"),
                              data=prepare_dat,
                              cov.model="exponential", sigma.sq.IG=c(2,
                                                                     0.5*var(prepare_dat$log_traffic)),
...
saveRDS(traffic_nngp_a4,'a4_full_nocov_log.rds')
proc.time() - ptm
