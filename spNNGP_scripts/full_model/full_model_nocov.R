...
traffic_nngp_a1 <- spConjNNGP(median_traffic~1,
...
saveRDS(traffic_nngp_a1,'a1_full_nocov.rds')
proc.time() - ptm
...
traffic_nngp_a2 <- spConjNNGP(median_traffic~1,
                              coords=c("LINE_LONGI","LINE_LATIT"),
                              data=prepare_dat,
                              cov.model="exponential", sigma.sq.IG=c(2,
                                                                     0.5*var(prepare_dat$median_traffic)),
...
saveRDS(traffic_nngp_a2,'a2_full_nocov.rds')
proc.time() - ptm
...
traffic_nngp_a3 <- spConjNNGP(median_traffic~1,
                              coords=c("LINE_LONGI","LINE_LATIT"),
                              data=prepare_dat,
                              cov.model="exponential", sigma.sq.IG=c(2,
                                                                     0.5*var(prepare_dat$median_traffic)),
...
saveRDS(traffic_nngp_a3,'a3_full_nocov.rds')
proc.time() - ptm
...
traffic_nngp_a4 <- spConjNNGP(median_traffic~1,
                              coords=c("LINE_LONGI","LINE_LATIT"),
                              data=prepare_dat,
                              cov.model="exponential", sigma.sq.IG=c(2,
                                                                     0.5*var(prepare_dat$median_traffic)),
...
saveRDS(traffic_nngp_a4,'a4_full_nocov.rds')
proc.time() - ptm
